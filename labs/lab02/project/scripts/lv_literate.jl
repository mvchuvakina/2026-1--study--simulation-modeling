...
#
# **Цель работы:** Исследовать колебательную динамику в системе
...
# - $\beta$ — скорость поедания жертв хищниками
# - $\delta$ — коэффициент конверсии (эффективность превращения жертв в хищников)
