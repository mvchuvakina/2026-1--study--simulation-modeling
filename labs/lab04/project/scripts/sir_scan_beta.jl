...
for (i, params) in enumerate(params_list)
    ...
    println("Завершен эксперимент $i/$(length(params_list)): beta = $(params[:beta]), seed = $(params[:seed])")
end
...
println("\nГрафик сохранён в: ", plotsdir("beta_scan.png"))
println("Результаты сохранены в data/beta_scan_all.csv")
