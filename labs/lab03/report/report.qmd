...
![Начальное состояние (шаг 0)](../project/plots/daisy_step001.png){#fig:step1 width=70%}

![После 5 итераций (шаг 5)](../project/plots/daisy_step005.png){#fig:step5 width=70%}

![После 45 итераций (шаг 45)](../project/plots/daisy_step045.png){#fig:step45 width=70%}

## Анализ численности маргариток

На рис. 4 представлена динамика численности черных и белых маргариток.

![Динамика численности маргариток](../project/plots/daisy_count.png){#fig:count width=100%}
