...
![Компиляция отчета](image/6.png){#fig:006 width=70%}
...
![Зависимость deadlock от N](../project/plots/parametric_N.png){#fig:param_N1 width=100%}
...
![Зависимость deadlock от tmax](../project/plots/parametric_tmax.png){#fig:param_tmax1 width=100%}
