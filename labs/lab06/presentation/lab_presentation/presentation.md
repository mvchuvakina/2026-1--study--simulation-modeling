...
![Сравнение динамик](../../project/plots/comparison.png){#fig:comparison width=100%}
...
![Сравнение методов](../../project/plots/sir_parametric_comparison.png){#fig:method_comp width=100%}
